let githubUser = 'hsanond'
let repo = 'hsanond.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbzxnV7Z6_33zDC1gihlHg4EArkPfNaWjQ2OxNBX-EixXZHz_ukFNE_fs71QYUv7yyzV9A/exec');
